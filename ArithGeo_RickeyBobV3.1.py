...
def Geometric():
    ...
    while True:
        try:
            ...
            print ("Please enter vaild interger greater than 1")
    while True:
        try:
    ...
    while True:
        try:
            ...
            print ("please enter valid number, and the common ratio cannot be 1 or 0")
...
def Arithmetic():
    ...
    while True:
        try:
            ...
            print ("Please enter vaild integer greater than 1")
    while True:
        try:
            a = float(input("Please enter the first term: "))
            break
